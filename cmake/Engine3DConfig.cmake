...
if(WIN32)
    ...
    if(WITH_ViSP)
        ...
        set(VISP_INCLUDE_DIRS ${Engine3D_DIR}/include/3rdParty/ViSP)
        set(VISP_LIBRARIES_DIR ${Engine3D_DIR}/lib/$<CONFIG>/3rdParty/ViSP)
...
elseif(UNIX)
    ...
    if(WITH_OpenVR)
        add_compile_definitions(HAVE_OpenVR)
        list(APPEND Engine3D_LIBRARIES openvr_api)
    endif()
endif()
...
if(WIN32)
    ...
    list(APPEND Engine3D_LIBRARIES ${Engine3D_DIR}/lib/Engine3D$<$<CONFIG:Debug>:d>.lib)
